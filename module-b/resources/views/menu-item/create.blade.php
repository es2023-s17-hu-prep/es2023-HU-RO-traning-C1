...
@section('content')
    ...
    <form action="/menu" enctype="multipart/form-data" method="POST" class="w-full flex flex-col gap-4">
        <h1 class="text-3xl font-bold">Create menu item</h1>
        ...
        <div class="flex flex-col gap-1 w-full">
            ...
            <input id="name" type="text" name="name" placeholder="name" class="p-2 border rounded-sm w-full" value="{{old('name')}}">
            @error('name')
        ...
        <div class="flex flex-col gap-1 w-full">
            ...
            <input id="price" type="text" name="price" placeholder="price"
                   class="p-2 border rounded-sm w-full" value="{{old('price')}}">
            @error('price')
            <div class="text-red-500 mt-2">{{$message}}</div>
            @enderror
        </div>
